...
if("TRUE" STREQUAL "TRUE")
  set(lab7_SOURCE_PREFIX /home/user/tesis/src/frlabs/lab7)
  set(lab7_DEVEL_PREFIX /home/user/tesis/devel)
  set(lab7_INSTALL_PREFIX "")
  set(lab7_PREFIX ${lab7_DEVEL_PREFIX})
else()
  set(lab7_SOURCE_PREFIX "")
  set(lab7_DEVEL_PREFIX "")
  set(lab7_INSTALL_PREFIX /home/user/tesis/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/tesis/src/frlabs/lab7/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lab7_EXPORTED_TARGETS ${${lab7_dep}_EXPORTED_TARGETS})
endforeach()
